...
class Question(BaseModel):
    ...
    framework = models.ForeignKey(
        ...
        verbose_name=_("Framework category"),
        help_text=_("Question framework category"),
    )
    ...
    language = models.ForeignKey(
        ...
        related_name="questions",
        on_delete=models.SET_NULL,
        verbose_name=_("Language category"),
        help_text=_("Question language category"),
    )
    is_public = models.BooleanField(
        default=True, verbose_name=_("Is public"), help_text=_("Field specifies if user can see question instance")
    )
